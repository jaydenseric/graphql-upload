 ...
 * @param {string} [options.encoding='utf8'] Encoding for buffers to use to decode strings. Valid values depend on the [Node.js `Buffer` implementation](https://github.com/nodejs/node/blob/v13.7.0/lib/buffer.js#L587-L663).
